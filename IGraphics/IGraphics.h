...
#pragma mark - Drawing API implementation
   ...
   * @param pBlend Optional blend method
   * @param thickness Optional line thickness
   * @param options IStrokeOptions for the path */
  virtual void DrawTriangle(const IColor& color, float x1, float y1, float x2, float y2, float x3, float y3, const IBlend* pBlend = 0, float thickness = 1.f, IStrokeOptions options = IStrokeOptions());
   ...
   * @param thickness Optional line thickness
   * @param options IStrokeOptions for the path */
  virtual void DrawRect(const IColor& color, const IRECT& bounds, const IBlend* pBlend = 0, float thickness = 1.f, IStrokeOptions options = IStrokeOptions());
   ...
   * @param thickness Optional line thickness
   * @param options IStrokeOptions for the path */
  virtual void DrawRoundRect(const IColor& color, const IRECT& bounds, float cornerRadius = 5.f, const IBlend* pBlend = 0, float thickness = 1.f, IStrokeOptions options = IStrokeOptions());
   ...
   * @param thickness Optional line thickness
   * @param options IStrokeOptions for the path */
  virtual void DrawRoundRect(const IColor& color, const IRECT& bounds, float cRTL, float cRTR, float cRBR, float cRBL, const IBlend* pBlend = 0, float thickness = 1.f, IStrokeOptions options = IStrokeOptions());
   ...
   * @param thickness Optional line thickness
   * @param options IStrokeOptions for the path */
  virtual void DrawArc(const IColor& color, float cx, float cy, float r, float a1, float a2, const IBlend* pBlend = 0, float thickness = 1.f, IStrokeOptions options = IStrokeOptions());
   ...
   * @param thickness Optional line thickness
   * @param options IStrokeOptions for the path */
  virtual void DrawCircle(const IColor& color, float cx, float cy, float r, const IBlend* pBlend = 0, float thickness = 1.f, IStrokeOptions options = IStrokeOptions());
   ...
   * @param thickness Optional line thickness
   * @param options IStrokeOptions for the path */
  virtual void DrawEllipse(const IColor& color, const IRECT& bounds, const IBlend* pBlend = 0, float thickness = 1.f, IStrokeOptions options = IStrokeOptions());
   ...
   * @param thickness Optional line thickness
   * @param options IStrokeOptions for the path */
  virtual void DrawEllipse(const IColor& color, float x, float y, float r1, float r2, float angle = 0.0, const IBlend* pBlend = 0, float thickness = 1.f, IStrokeOptions options = IStrokeOptions());
   ...
   * @param thickness Optional line thickness
   * @param options IStrokeOptions for the path */
  virtual void DrawConvexPolygon(const IColor& color, float* x, float* y, int nPoints, const IBlend* pBlend = 0, float thickness = 1.f, IStrokeOptions options = IStrokeOptions());
